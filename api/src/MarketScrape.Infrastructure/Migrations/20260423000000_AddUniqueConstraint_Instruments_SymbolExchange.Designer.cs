...
namespace MarketScrape.Infrastructure.Migrations
{
    ...
    [Migration("20260423000000_AddUniqueConstraint_Instruments_SymbolExchange")]
    partial class AddUniqueConstraint_Instruments_SymbolExchange
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MarketScrape.Core.Entities.Instrument", b =>
                {
                    ...
                    b.HasIndex(new[] { "Symbol", "Exchange" }, "IX_instruments_symbol_exchange")
                        .IsUnique();
